...
namespace CheapLoansDisplay.localhost {
    using System;
    ...
    public partial class LoanService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public LoanService() {
            this.Url = global::CheapLoansDisplay.Properties.Settings.Default.CheapLoansDisplay_localhost_LoanService;
        ...
        /// <remarks/>
        public void GetLoanByCustomerAsync(string customerName) {
            this.GetLoanByCustomerAsync(customerName, null);
        }
        
        /// <remarks/>
        public void GetLoanByCustomerAsync(string customerName, object userState) {
            ...
            this.InvokeAsync("GetLoanByCustomer", new object[] {
                        customerName}, this.GetLoanByCustomerOperationCompleted, userState);
        }
